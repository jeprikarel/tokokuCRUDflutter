...
void deleteData(){
  var url="http://192.168.1.7/tokoku/deleteData.php";
  http.post(url, body: {
...
void confirm (){
  AlertDialog alertDialog = new AlertDialog(
    content: new Text("Anda yakin akan menghapus '${widget.list[widget.index]['username']}'"),
    actions: <Widget>[
      new RaisedButton(
          ...
          child: new Center(
            child: new Column(
              children: <Widget>[
                ...
                Divider(),
                new Text("Level : ${widget.list[widget.index]['nivel']}", style: new TextStyle(fontSize: 18.0),),
                new Padding(padding: const EdgeInsets.only(top: 30.0),),
